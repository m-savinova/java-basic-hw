...
public class MainApp {
    public static void main(String[] args) {
        ...
        System.out.println((filterListUser.getOverMinAge(users, 30)));
        System.out.println(filterListUser.isExceedsAverageAge(users, 29));
        System.out.println(filterListUser.getYoungestUser(users));
    }
}